...
public abstract class ServiceProxy 
{
    ...
    protected void EnsureApiAuthenticated() throws Exception
    {
        ...
        if (asString == null || asString.length() == 0)
        {
            ...
            {
                throw new Exception(Formatter.formatMessage("The server request failed with the error '{0}'.  Ensure that you have set the values of the ApiUsername and ApiPassword constants to the credentials of your Six Bookmarks service account at {1}.",
                    new String[] { new Integer(response.getResult()).toString(), RootUrl }));
            }
        }
    }
